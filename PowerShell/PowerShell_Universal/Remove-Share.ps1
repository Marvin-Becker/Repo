...
$AvailableDomains = @{
    ...
    "ADS.HETTICH.COM"                = "ADS"
    "ASYSAIRPLUS.DE"                 = "APL"
    "ARVATOPAYMENT.COM"              = "ARVATOPAYPMENT"
    "ARVSYS.LOC"                     = "ARVSYS"
    ...
    "DE.ALFA.LOCAL"                  = "DE"
    "EXT.ARVATO-SERVICES.ORG "       = "DEASORG"
    "NAT.ARVATO-SERVICES.ORG "       = "DEASORG"
    ...
    "HGROUP.INTRA"                   = "HGROUP"
    "ARVATO-INFOSCORE.NET"           = "IFS"
    "MAG.BERTELSMANN.COM"            = "MAG"
    ...
    "ARVATOSYSTEMS-TRACKANDTRACE.DE" = "TRT"
    "VRH.LOCAL"                      = "VRH"
