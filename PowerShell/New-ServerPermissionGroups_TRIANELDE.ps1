...
Start-Transcript -Path 'C:\SZIR\Scripting\New-ServerPermissionGroups\Log.txt'
...
$ServerPaths = @('OU=SRV,OU=ASYS-Managed-Servers,OU=Arvato Systems GmbH,DC=trianel,DC=de')
